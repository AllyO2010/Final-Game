...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, walls, rocks, trees, cavewalls, bushes):
        ...
        if pygame.sprite.spritecollide(self, walls, False, pygame.sprite.collide_mask) or pygame.sprite.spritecollide(self, rocks, False, pygame.sprite.collide_mask) or pygame.sprite.spritecollide(self, trees, False, pygame.sprite.collide_mask) or pygame.sprite.spritecollide(self, cavewalls, False, pygame.sprite.collide_mask) or pygame.sprite.spritecollide(self, bushes, False, pygame.sprite.collide_mask):
            self.rect.x = old_x
...
def load_maze(filename):
    ...
    return all_sprites, wall_sprites, player, tree_sprites, cave, rock_sprites, cavewall_sprites, diamond, lava_sprites, bush_sprites, keybush, exit_sprites, cabin
...
def main():
    ...
    all_sprites, wall_sprites, player, tree_sprites, cave, rock_sprites, cavewall_sprites, diamond, lava_sprites, bush_sprites,keybush, exit_sprites, cabin = load_maze(file)
    ...
    while running:
      ...
      if LOCATION==1:
         ...
         if not level_won:
              player.update(wall_sprites, rock_sprites, tree_sprites, cavewall_sprites,bush_sprites)
